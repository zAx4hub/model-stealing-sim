...
> Simulate model stealing via query APIs

**Author:** zAx4hub

## Problem

Simulate model stealing via query APIs. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`model-stealing-sim` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **parser** engine, CLI, examples, and tests.
